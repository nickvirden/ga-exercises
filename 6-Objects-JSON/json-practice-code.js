...
"NO, because you don't need to set a var in JSON."
...
var grungeAlbumJSON = JSON.stringify(grungeAlbums);
...
var revertedGAJSON = grungeAlbumJSON.parse(grungeAlbumJSON);
...
var pokedexJSON = JSON.stringify(pokedex);
var revertedpokedexJSON = grungeAlbumJSON.parse(pokedexJSON);